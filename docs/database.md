...
| Linktrees and public content     | `linktrees`, `links`, `whatsapp_questions`, `campaign_revenue_records`, `template_global_settings`, `public_pages`, `public_page_versions`, `public_page_actions`, `public_page_tombstones`                                                                                 |
